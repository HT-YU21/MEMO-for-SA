...
if __name__ == '__main__':
    ...
    dataset_files = {
            'twitter': {
                'train': './ALSA/twitter/train.raw',
                'test': './ALSA/twitter/test.raw'
            },
            'restaurant': {
                'train': './ALSA/restaurant/restaurant_train.raw',
                'test': './ALSA/restaurant/restaurant_test.raw'
                },
            'mams': {
                'train': './ALSA/mams/mams_train.txt',
                'test': './ALSA/mams/mams_test.txt'
            },
            'memo': {
                'train': './ALSA/memo/MEMO_Train.txt',
                'test': './ALSA/memo/MEMO_Test.txt'
            },
            'laptop': {
                'train': './ALSA/laptop/laptop_train.raw',
                'test': './ALSA/laptop/laptop_test.raw'                                            
                },
    }
    input_colses = {
        'lstm': ['text_indices'],
        ...
        'senticgcn': ['text_indices', 'aspect_indices', 'left_indices', 'dependency_graph'],
        'affgcn': ['text_indices', 'aspect_indices', 'left_indices', 'dependency_graph'],
        'attgcn': ['text_indices', 'aspect_indices', 'left_indices', 'dependency_graph'],
    }
