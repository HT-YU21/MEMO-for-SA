...
from models import SenticGCN_BERT, BERT_SPC, TD_LSTM, TC_LSTM, Cabasc, TNet_LF, LCF_BERT
...
def main():
    ...
    parser.add_argument('--dataset', default='memo', type=str, help='memo, mams, restaurant, laptop, twitter')
