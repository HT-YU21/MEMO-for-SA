...
from models import LSTM, SenticGCN, ATTSenticGCN, SDGCN, AFFGCN, IAN, MemNet, BERT_SPC, AEN_BERT, RAM, TD_LSTM, TC_LSTM, Cabasc, ATAE_LSTM, TNet_LF, AOA, MGAN, ASGCN, LCF_BERT, ASCNN, ASTCN
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='memo', type=str, help='twitter, memo, mams, restaurant, laptop)
    ...
    input_colses = {
        ...
        'attsenticgcn': ['text_indices', 'aspect_indices', 'left_indices', 'sentic_graph'],
	  ...
	  'tnet_lf': ['text_indices', 'aspect_indices', 'aspect_boundary'],
        ...
        'asgcn': ['text_indices', 'aspect_indices', 'left_indices', 'sentic_graph'],
        'bert_spc': ['concat_bert_indices', 'concat_segments_indices'],
        'aen_bert': ['text_bert_indices', 'aspect_bert_indices'],
        'lcf_bert': ['concat_bert_indices', 'concat_segments_indices', 'text_bert_indices', 'aspect_bert_indices'],
        'astcn': ['text_indices', 'aspect_indices', 'left_indices', 'sentic_graph'],
